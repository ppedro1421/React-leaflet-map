      ...
      >
        <LayersControl position="topright">
          ...
          <LayersControl.Overlay name='South America Bound'>
            <Rectangle bounds={southAmericaBound}>
              <Popup>South America Bound</Popup>
            </Rectangle>
          </LayersControl.Overlay>
          <LayersControl.Overlay name='World Bound'>
            <Rectangle bounds={worldBound}>
              <Popup>World Bound</Popup>
            </Rectangle>
          </LayersControl.Overlay>
          <LayersControl.Overlay name='Marcos'>
            <LayerGroup>
              <Circle center={[-22.906138, -43.174528]} radius={50000} pathOptions={{ color: 'red' }}>
                <Popup>RJ</Popup>
              </Circle>
              <Circle center={[-23.535141, -46.623467]} radius={50000} pathOptions={{ color: 'red' }}>
                <Popup>SP</Popup>
              </Circle>
            </LayerGroup>
          </LayersControl.Overlay>
